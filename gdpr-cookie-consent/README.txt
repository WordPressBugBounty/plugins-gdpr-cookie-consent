...
[WPLP Cookie Consent](https://wplegalpages.com/cookie-consent/?utm_source=+wordpress.org&utm_medium=referral+&utm_campaign=wpcookieconsent) is a free WordPress cookie consent plugin that adds a customizable cookie banner, blocks third-party scripts until visitors consent, and keeps your cookie disclosures accurate with a built-in cookie scanner. Help meet GDPR, CCPA/CPRA, ePrivacy, UK GDPR, LGPD, POPIA, PIPEDA and other global privacy law requirements - with consent records stored on your own site, not a third-party dashboard.
...
== ⚖️ Why Choose WPLP Cookie Consent Over a SaaS CMP ==
...
== 🛡️ Supported Privacy Laws & Regulations ==
...
For questions related to features or compatibility, you can [contact the WPLP Legal Pages support team](https://wplegalpages.com/contact-us/?utm_source=+wordpress.org&utm_medium=referral+&utm_campaign=wpcookieconsent).
...
* **Improvements**
    * Updated the GDPR cookie banner to better align with the latest GDPR compliance guidelines.
    * Enhanced the CCPA opt-out banner for improved usability and compliance.
...
= 4.2.3 =
* Fixed minor issues with IAB TCF
...
= 3.9.7 =
* Added two new cookie banner templates.
* Fixed: Debug log warnings.
* Fixed: Policy details block name.
...
* Fixed: Button size customization was not applied consistently to all buttons (Accept, Accept All, Decline, Cookie Settings).
* Fixed: PHP Notices and warning messages under GDPR settings.
...
= 3.9.1 =
* Improvement: Improved functional cookie handling under Google Consent Mode (GCM) settings for better accuracy and categorization.
* Fix: Resolved accessibility issues to ensure better compliance with WCAG (Web Content Accessibility Guidelines).

= 3.9.0 =
* Revamped Cookie Banner Structure: All banner templates are now fully responsive and optimized to display perfectly across all devices and screen sizes.
* Fixed Google Consent Mode Checker Issue: Resolved an issue where the "Check Status" feature was not accurately reflecting implementation results. Now users get reliable feedback on their Consent Mode setup.

= 3.8.4 =
* Added email notification for Google Consent Mode implementation status: Users will now receive an email with the status details when they click the “Check Status” button in the plugin. This helps you stay informed and take quick action if anything needs fixing.

= 3.8.3 =
* Improvement: Minor improvements.
* Improvement: Improved performance affecting page load speed.
...
= 2.5.1 =
* Fix: Minor bugs fixed within plugin and UI Enhancements.
...
= 2.4.0 =
* Feature: LGPD : Added new options to comply with LGPD law.
* Fix: Minor bugs fixed within plugin.
...
= 2.3.4 =
* Feature: Introducing: 2 Additional Widget Styles for Cookie Banners
* Fix: Minor bugs fixed within plugin.
...
* Feature: Accept All Button for Cookie Banner.
* Fix: Cookie value encoding fixes.
